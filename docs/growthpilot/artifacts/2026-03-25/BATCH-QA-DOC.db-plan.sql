...
create table if not exists qa_staging.import_batches (
...
create table if not exists qa_staging.staging_raw_rows (
...
create table if not exists qa_staging.staging_normalized_rows (
  batch_id text not null,
  source_file text not null,
  source_sheet text not null,
  source_row_no integer not null,
...
create table if not exists qa_staging.staging_rejects (
  batch_id text not null,
  source_file text not null,
  source_sheet text not null,
  source_row_no integer not null,
