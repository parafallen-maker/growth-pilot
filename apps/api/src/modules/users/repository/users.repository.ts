...
const permDefs = [
  ...
  { code: 'homework:view', name: '查看作业', module: 'homework', action: 'view' },
  { code: 'homework:review', name: '批改作业', module: 'homework', action: 'review' },
  { code: 'homework:error-taxonomies:view', name: '查看错因标签', module: 'homework', action: 'view' },
  { code: 'homework:error-taxonomies:manage', name: '管理错因标签', module: 'homework', action: 'manage' },
  { code: 'homework:analyze', name: '分析作业', module: 'homework', action: 'analyze' },
  { code: 'homework:export', name: '导出作业', module: 'homework', action: 'export' },
  { code: 'growth:rubrics:view', name: '查看评价模板', module: 'growth', action: 'view' },
  { code: 'growth:rubrics:manage', name: '管理评价模板', module: 'growth', action: 'manage' },
  { code: 'growth:observations:view', name: '查看习惯观察', module: 'growth', action: 'view' },
  { code: 'growth:observations:manage', name: '管理习惯观察', module: 'growth', action: 'manage' },
  { code: 'growth:goals:view', name: '查看成长目标', module: 'growth', action: 'view' },
  { code: 'growth:goals:manage', name: '管理成长目标', module: 'growth', action: 'manage' },
  { code: 'growth:reports:view', name: '查看成长报告', module: 'growth', action: 'view' },
  { code: 'growth:reports:manage', name: '管理成长报告', module: 'growth', action: 'manage' },
  { code: 'tasks:view', name: '查看待办任务', module: 'tasks', action: 'view' },
  { code: 'tasks:manage', name: '管理待办任务', module: 'tasks', action: 'manage' },
  { code: 'alerts:view', name: '查看告警', module: 'alerts', action: 'view' },
