...
export const navSections: NavSection[] = [
  ...
  },
  {
    title: '分析',
    items: [
      { label: 'Analytics Overview', href: '/analytics/overview', permission: 'analytics:overview:view' },
      { label: 'Analytics Teaching', href: '/analytics/teaching', permission: 'analytics:teaching:view' },
      { label: 'Analytics Billing', href: '/analytics/billing', permission: 'analytics:billing:view' },
    ],
  },
  {
    title: '系统设置',
